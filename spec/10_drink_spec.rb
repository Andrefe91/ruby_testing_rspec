...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:a_drink) { described_class.new('cola') }


      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(a_drink.type).to eq('cola')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(a_drink.ounces).to eq(16)
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      ...
      subject(:my_drink) {described_class.new('orange_juice', 20)}
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_drink) {described_class.new('orange_juice', 14)}
      # remove the 'x' before running this test
      it 'is not full' do
